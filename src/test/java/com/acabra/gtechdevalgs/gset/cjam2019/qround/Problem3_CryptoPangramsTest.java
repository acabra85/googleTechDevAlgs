...
public class Problem3_CryptoPangramsTest {
    ...
    public void should_return_CJQUIZKNOWBEVYOFDPFLUXALGORITHMS() {
        ...
        Problem3_CryptoPangrams.Solution solution = Problem3_CryptoPangrams.Solution.ofConsole();
        MatcherAssert.assertThat(expected, Is.is(solution.findPlainText(new BigInteger("103"), 31, TestUtils.buildBigIntegerList(cypherList))));
    }
    ...
    public void should_return_SUBDERMATOGLYPHICFJKNQVWXZ() {
        ...
        Problem3_CryptoPangrams.Solution solution = Problem3_CryptoPangrams.Solution.ofConsole();
        MatcherAssert.assertThat(expected, Is.is(solution.findPlainText(new BigInteger("10000"), 25, TestUtils.buildBigIntegerList(cypherList))));
    }
    ...
    public void should_return_ZYXWVUTSRQPONMLKJIHGFEDCBA() {
        ...
        Problem3_CryptoPangrams.Solution solution =Problem3_CryptoPangrams.Solution.ofConsole();
        MatcherAssert.assertThat(expected, Is.is(solution.findPlainText(new BigInteger("101"), 25, TestUtils.buildBigIntegerList(cypherList))));
    }
    ...
    public void should_return_THEQUICKBROWNFOXJUMPSOVERTHELAZYDOG() {
        ...
        Problem3_CryptoPangrams.Solution solution =Problem3_CryptoPangrams.Solution.ofConsole();
        MatcherAssert.assertThat(expected, Is.is(solution.findPlainText(new BigInteger("101"), 34, TestUtils.buildBigIntegerList(cypherList))));
    }

    @Test
    public void test_read_file() throws IOException {
        Problem3_CryptoPangrams.Solution solution = Problem3_CryptoPangrams.Solution.ofTestFile("cjam2019/qround/p3.txt");
        solution.read();
    }
}
